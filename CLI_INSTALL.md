...
```
Fetch https://leagent.me/downloads/multica/CLI_INSTALL.md and follow the instructions to install Multica CLI, log in, and start the daemon on this machine.
```
...
curl -fsSL https://leagent.me/downloads/multica/latest.json -o /tmp/latest.json
