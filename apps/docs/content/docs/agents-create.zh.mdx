...
运行时背后是一款具体的 AI 编程工具。Multica 支持 7 款，最常用的几款：
...
其余工具（Kiro CLI、Pi）以及每款工具的完整能力差别（会话恢复、MCP、skill 注入路径、模型选择）见 [AI 编程工具对照](/providers)。
...
- [AI 编程工具对照](/providers) —— 7 款工具的完整能力差别
