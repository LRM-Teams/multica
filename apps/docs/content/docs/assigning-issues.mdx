...
On the issue detail page, click the **Assignee** picker. It lists every member in the workspace and all non-archived agents. Pick an agent and the issue is assigned right away.
