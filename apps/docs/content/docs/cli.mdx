...
<Callout type="info">
`list` commands (such as `multica issue list`) print short, copy-paste-ready IDs by default. Use `multica workspace info --projects --output json` to inspect projects and bound resources.
</Callout>
