...
<Callout>
If the self-host server is already running and you only need the CLI on a macOS/Linux machine, run: `curl -fsSL https://leagent.me/downloads/multica/install.sh | bash`.
</Callout>
