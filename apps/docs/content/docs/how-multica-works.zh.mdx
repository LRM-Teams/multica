...
- **AI 编程工具**——[Claude Code](/providers#claude-code)、[Codex](/providers#codex)、[Cursor](/providers#cursor)、[Grok](/providers#grok)、[Kiro CLI](/providers#kiro-cli)、[OpenCode](/providers#opencode)、[Pi](/providers#pi) 7 款之一（或多款并存）。守护进程领到任务后，用这些工具真正去写代码。
