...
- **Local [daemon](/daemon-runtimes)** — you run `multica daemon` on your own machine, and it drives the [AI coding tools](/providers) installed locally. Seven are built in today: [Claude Code](/providers#claude-code), [Codex](/providers#codex), [Cursor](/providers#cursor), [Grok](/providers#grok), [Kiro CLI](/providers#kiro-cli), [OpenCode](/providers#opencode), [Pi](/providers#pi). Your API keys, toolchain, and code directories stay on your machine.
