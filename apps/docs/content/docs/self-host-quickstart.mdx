...
```bash
multica setup --environment test --test-url http://localhost:8081 /<workspace-slug>
```
...
```bash
multica setup --environment test --test-url https://<your-domain> /<workspace-slug>
```
...
```bash
multica setup --environment test --test-url http://api.multica.dev.lan /<workspace-slug>
```
