...
export function createEnDict(allowSignup: boolean): LandingDict {
  ...
  features: {
    ...
    runtimes: {
      ...
      description:
        "Local daemons and cloud runtimes, managed from a single panel. Real-time monitoring of online/offline status, usage charts, and activity heatmaps. Auto-detects 7 supported coding tools on your machine.",
      cards: [
        {
        ...
        },
        {
          ...
          description:
            "Multica scans for 7 supported coding tools \u2014 Claude Code, Codex, Cursor, Grok, Kiro CLI, OpenCode, and Pi \u2014 and registers a runtime for each one it finds.",
        },
      ],
    },
  },
  ...
  howItWorks: {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          "Run multica setup \u2014 it walks you through OAuth, starts the daemon, and scans for the 7 supported coding tools (Claude Code, Codex, Cursor, Grok, Kiro CLI, OpenCode, Pi). Whichever ones you already have installed get registered as runtimes automatically.",
      },
      {
    ...
    items: [
      {
        ...
        answer:
          "Multica supports 7 coding tools out of the box: Claude Code, Codex, Cursor, Grok, Kiro CLI, OpenCode, and Pi. The daemon auto-detects whichever CLIs you already have installed and registers a runtime for each one. Since it's open source, you can also add your own backends.",
      },
      {
