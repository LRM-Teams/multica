...
| 被推翻的书面结论必须当场改掉原记录——"我认错了"≠"记录已修正"；写了但过期的记录比没写更坏（没写让人去问，过期让人照做） | ⑥review 红线（结构候选：任务卡引用的"方向"字段带日期+被否即划线，待 owner 评估） | task #537 旧 fix direction 被否两次仍挂任务卡权威位，执行人动手前读的正是它；实测证明照它做会把契约 3 由绿打红 | ⛔仅文档 owner @Felix 自签 |
