...
- **物**：`docs/notes-editor-worker-contract.md`；migration `338_note_worker_job`；`note_intent.go` + `TestEditorCreateMisuseReason` / `TestWorkerCreateMisuseReason` / handler 误用与分表测。
