...
Multica iOS 客户端开源,跟 web、desktop、后端一起放在[主仓库](https://github.com/LRM-Teams/multica)里。目前没上 App Store —— 在那之前,想用的人自己从源码 build 一份。首次 build 约 10–20 分钟,之后每次约 2 分钟,连接的是 [multica.ai](https://multica.ai) 同一个后端,所以你现有账号直接能登。

<Callout type="info">
本页是给**个人使用者**看的。如果你是要开发这个 app,请看仓库里的 [`apps/mobile/README.md`](https://github.com/LRM-Teams/multica/blob/main/apps/mobile/README.md) —— 那里覆盖 dev / staging 变体和完整脚本表。
</Callout>
...
想第一时间知道 TestFlight 开放的话,watch 一下 [GitHub 仓库](https://github.com/LRM-Teams/multica)。
