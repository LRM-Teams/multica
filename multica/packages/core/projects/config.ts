...
> = {
  ...
  completed: { label: "Completed", color: "text-muted-foreground", dotColor: "bg-muted-foreground/40", badgeBg: "bg-muted", badgeText: "text-muted-foreground" },
...
> = {
  ...
  low: { label: "Low", bars: 1, color: "text-brand", badgeBg: "bg-brand/10", badgeText: "text-brand" },
