...
func TestRedisModelListStore_CreateGetComplete(t *testing.T) {
	...
	req, err := store.Create(ctx, "runtime-1", false, false)
	if err != nil {
...
func TestRedisModelListStore_PopPendingAcrossInstances(t *testing.T) {
	...
	req, err := nodeA.Create(ctx, "runtime-cross", false, false)
	if err != nil {
...
func TestRedisModelListStore_PopPendingConcurrent(t *testing.T) {
	...
	req, err := store.Create(ctx, "runtime-race", false, false)
	if err != nil {
		t.Fatalf("create: %v", err)
	}
...
func TestRedisModelListStore_PendingTimeout(t *testing.T) {
	...
	req, err := store.Create(ctx, "runtime-timeout", false, false)
	if err != nil {
		t.Fatalf("create: %v", err)
	}
...
func TestRedisModelListStore_RunningTimeout(t *testing.T) {
	...
	req, err := store.Create(ctx, "runtime-running-timeout", false, false)
	if err != nil {
		t.Fatalf("create: %v", err)
	}
...
func TestRedisModelListStore_HasPending(t *testing.T) {
	...
	if _, err := store.Create(ctx, "rt-1", false, false); err != nil {
		t.Fatalf("create: %v", err)
	}
