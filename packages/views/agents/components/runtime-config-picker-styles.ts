/**
 * Shared density for runtime-config pickers (Computer / Runtime / Model /
 ...
 */
export const runtimeConfigFieldClass = "flex min-w-0 flex-col gap-1.5";

export const runtimeConfigTriggerClass =
