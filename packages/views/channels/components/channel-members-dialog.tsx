 ...
 * LRM-647 lock: Plan A + less chrome — no duplicate count strip / footer count;
 * Add outline secondary; footer Done only; People/Agents grouping lives in the list.
 */
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <DialogFooter className="mx-0 mb-0 mt-0 shrink-0 flex-row items-center justify-end gap-2 rounded-none border-t border-border px-3.5 py-2 sm:justify-end max-sm:pb-[max(0.75rem,env(safe-area-inset-bottom))]">
          <Button
            type="button"
            variant="ghost"
            className="h-8 px-2.5 font-bold text-brand hover:bg-transparent hover:text-brand/90"
