...
export function ChannelMessageBubble({
  ...
  // Avatar resolution (LRM-202 / LRM-218): payload → sticky same-author cache →
  // actor directory (same source as the profile card). WS upserts also preserve
  // URLs in `withPreservedAuthorAvatar` so consecutive bubbles don't regress
  // to glyph placeholders when a publish path omits `author_avatar_url`.
