 ...
 *
 * LRM-594 / LRM-591 荐 A: agent DM header has no Working/Thinking text —
 * work state lives on Activity; Stop lives in AgentProfileActions (LRM-589).
 * 1:1 has no Stop all.
 *
...
function DmHeader({
  ...
  // LRM-594 / LRM-584 K=1: agent peers use avatar badge only — no Working /
  // Thinking header text. Work → Activity; Stop → AgentProfileActions (LRM-589).
  // Human peers keep the static "Human" meta.
