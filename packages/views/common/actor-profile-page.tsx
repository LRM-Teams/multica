 ...
 * (always GetAgent by id — LRM-292); users and unavailable agents retain the
 * generic profile fallback. The agent page keeps the Back/header chrome
 * outside the tab body's scroll container.
 *
