...
/**
 * LRM-1085 / action-areas v5 — detail-header right slot (S1):
 * Restart outline only. Empty / non-actionable ⋯ removed (Frank).
 * Upgrade lives on the Daemon Basics row; Delete lives in Danger Zone only.
 * Blocked Restart reason stays on the button `title` tooltip.
 */
