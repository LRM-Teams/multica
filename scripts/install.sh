...
run_with_server() {
  ...
  printf "\n"
  printf "  ${BOLD}Next:${RESET} this self-hosted server is running. The legacy\n"
  printf "  'multica setup self-host' CLI surface is retired in this Computer\n"
  printf "  generation; the resident Computer authenticates through Multica Cloud\n"
  printf "  (leagent.me).\n"
  printf "\n"
