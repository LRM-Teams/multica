...
require_config "$deploy_workflow" 'VOLCENGINE_RTC_LLM_URL: ${{ secrets.VOLCENGINE_RTC_LLM_URL }}'
require_config "$deploy_workflow" 'VOLCENGINE_RTC_LLM_API_KEY: ${{ secrets.VOLCENGINE_RTC_LLM_API_KEY }}'
