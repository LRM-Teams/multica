	...
	r.Group(func(r chi.Router) {
		...
		r.Route("/api/workspaces", func(r chi.Router) {
			...
			r.Route("/{id}", func(r chi.Router) {
				...
				r.Group(func(r chi.Router) {
					...
					r.Get("/graph-memory/channels/{channelId}/mode", h.GetGraphMemoryChannelMode)
		...
		r.Group(func(r chi.Router) {
			...
			r.Route("/api/notes", func(r chi.Router) {
				...
				r.Get("/period-briefs/plan", h.GetNotePeriodBriefPlan)
				r.Put("/period-briefs/plan", h.PutNotePeriodBriefPlan)
				r.Delete("/period-briefs/plan", h.DeleteNotePeriodBriefPlan)
				r.Post("/period-briefs/{runId}/insert", h.InsertNotePeriodBrief)
				r.Post("/period-briefs/{runId}/cancel", h.CancelNotePeriodBrief)
				r.Route("/pages", func(r chi.Router) {
					r.Get("/", h.ListNotePages)
					r.Post("/", h.CreateNotePage)
					r.Get("/trash", h.ListDeletedNotePages)
					r.Delete("/trash", h.EmptyNoteTrash)
					r.Route("/{id}", func(r chi.Router) {
						r.Get("/", h.GetNotePage)
						...
						r.Post("/worker-jobs", h.CreateNoteWorkerJob)
						...
						r.Get("/agent-refs", h.ListNotePageAgentRefs)
						r.Post("/agent-refs", h.CreateNotePageAgentRef)
						r.Delete("/agent-refs/{agentId}", h.DeleteNotePageAgentRef)
				...
				r.Get("/worker-jobs/{jobId}", h.GetNoteWorkerJob)
				r.Post("/writebacks/{writebackId}/accept", h.AcceptNotePageWriteback)
				r.Post("/writebacks/{writebackId}/reject", h.RejectNotePageWriteback)
			})
			...
			r.Route("/api/issues", func(r chi.Router) {
				...
				r.Route("/{id}", func(r chi.Router) {
					...
					r.Get("/note-refs", h.ListIssueNoteRefs)
					...
					r.Post("/pull-requests/rescan", h.RescanIssuePullRequest)
			...
			r.Route("/api/agent", func(r chi.Router) {
				...
				r.Post("/channels/{channelId}/graph-memory/{operation}", h.GraphMemoryAgentTool)
				r.Post("/channels/{channelId}/graph-memory-usage", h.GraphMemoryAgentUsage)
				...
				r.Get("/work-graphs/{graphId}/epochs", h.ListAgentWorkGraphEpochs)
				r.Post("/work-graphs/{graphId}/epochs", h.StartAgentWorkGraphEpoch)
				r.Post("/work-graphs/{graphId}/epochs/{epochId}/finish", h.FinishAgentWorkGraphEpoch)
				...
				r.Get("/notes/period-briefs/plan", h.GetAgentNotePeriodBriefPlan)
				r.Put("/notes/period-briefs/plan", h.PutAgentNotePeriodBriefPlan)
				r.Post("/notes/period-briefs/start", h.StartAgentNotePeriodBrief)
				r.Post("/notes/period-briefs/{runId}/insert", h.InsertAgentNotePeriodBrief)
			...
			r.Get("/api/conversations/lookup", h.LookupConversationHandle)
