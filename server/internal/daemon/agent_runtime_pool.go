...
func isResidentAcceptBusyErr(err error) bool {
	...
	return strings.Contains(msg, ": turn busy") ||
		strings.Contains(msg, "pi rpc turn busy") ||
		strings.Contains(msg, "input overlaps an active") ||
		strings.Contains(msg, "native input is active") ||
		strings.Contains(msg, "concurrent turn")
}
