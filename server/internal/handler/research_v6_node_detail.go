...
func (h *Handler) GetResearchV6ProjectionNodeDetail(w http.ResponseWriter, r *http.Request) {
	...
	detail, err := service.ProjectionV6NodeDetail(r.Context(), h.resolveWorkspaceID(r), strings.TrimSpace(chi.URLParam(r, "runId")), strings.TrimSpace(chi.URLParam(r, "nodeId")), strings.TrimSpace(r.URL.Query().Get("view")))
