...
func TestBuildResearchV6ProjectionSliceIsBoundedStableAndFiltered(t *testing.T) {
	...
	}, Edges: []researchV6ProjectionEdge{{ID: "e1", FromNodeID: "root", ToNodeID: "a", EdgeType: "decomposes"}, {ID: "e2", FromNodeID: "root", ToNodeID: "b", EdgeType: "decomposes"}, {ID: "e3", FromNodeID: "a", ToNodeID: "c", EdgeType: "depends_on"}}}
	...
	if err != nil || len(second.Nodes) != 1 || second.Nodes[0].Node.ID != "a" || second.NextCursor != nil {
