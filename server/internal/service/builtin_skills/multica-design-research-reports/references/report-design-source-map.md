...
| Document charset/viewport `<meta>` is allowed; `http-equiv` and other sandbox escapes stay rejected | `server/internal/researchrun/report_package_v6.go` (`reportForbidden`); `server/internal/researchrun/report_v6_security_test.go` |
