...
| Production evaluation Artifact extraction (M2b) | `server/internal/researcheval/canonical_artifact.go`; maps real Run Source/Observation/Claim ledgers through explicit controlled-document, subject-hash, fact and Evidence identities into the same Artifact graded by hidden Oracles; never infers missing facts from prose |
