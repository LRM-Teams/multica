...
| Strict structured result envelope, pinned v1/v2 behavior, v3 Method contract, and evidence validation | `server/internal/researchrun/result.go`, `result_v2.go`, `result_v3.go`, `result_test.go`, `postgres_result.go`, `postgres_gate.go` |
