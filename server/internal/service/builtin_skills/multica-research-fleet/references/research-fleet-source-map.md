...
| V6 canonical Node identity (N) | `server/internal/handler/research_v6_projection.go`; chooses identity by entity kind, rejects malformed/missing known identities in Snapshot/live V6, and preserves generic degradation for unknown future kinds |
