...
| Source independence family classifier (F, registry/Gate wiring pending) | `server/internal/researchrun/source_independence.go`, `source_independence_test.go`; located publisher/owner/dataset/syndication dependency closure, verified-identity qualification, one representative per family and stable audit fingerprints |
