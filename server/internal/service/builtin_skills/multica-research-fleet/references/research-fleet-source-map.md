...
| V6 compatibility projection integrity (N) | `server/internal/handler/research_v6_projection.go`; rejects duplicate/collapsed Node identities, duplicate Edge identities, dangling endpoints and empty Edge types before hashing a Snapshot |
