...
| Recursive Integration convergence contract (G, runtime wiring pending) | `server/internal/researchrun/integration_convergence.go`, `integration_convergence_test.go`; canonical-state-bound continue/await/converged/escalate decision, low-gain window and fail-closed round/depth/cost limits |
