...
func GetSegmentMessages(
	...
	messages, err := messageStore.MessagesForTaskInRange(ctx, db.MessagesForTaskInRangeParams{TaskID: segment.AgentRunID, StartSeq: segment.StartSeq, EndSeq: segment.EndSeq})
	if err != nil {
		return nil, err
	}
