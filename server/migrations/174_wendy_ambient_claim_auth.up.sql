-- Ambient reviews enqueue event radar runs (cooldown wendy_ambient:<channel>).
-- ClaimAgentTask / ListQueuedClaimCandidates / the dispatch guard all call
-- workspace_radar_task_is_authorized, which previously only allowed manual or
-- scheduled workspace-supervisor runs — ambient tasks stayed queued forever.
