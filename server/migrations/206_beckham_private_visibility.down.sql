-- Revert LRM-233: restore #general sync to visibility-only eligibility and
-- reopen live group managers as workspace-visible.
...
WHERE managed_role = 'group_manager'
  AND visibility IS DISTINCT FROM 'workspace'
