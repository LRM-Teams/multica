-- Recreate reply_feedback if rolling back LRM-613 drop.
...
CREATE INDEX IF NOT EXISTS idx_reply_feedback_message
  ON reply_feedback(message_kind, message_id);

CREATE INDEX IF NOT EXISTS idx_reply_feedback_workspace_agent
