...
BEGIN
  ...
  IF completed_count > 0 THEN
    RAISE EXCEPTION 'migration 321 down cannot proceed: % completed channel onboarding row(s) have no truthful representation in the older status contract', completed_count;
  END IF;
END $$;
