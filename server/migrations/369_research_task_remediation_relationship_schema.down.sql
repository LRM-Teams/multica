DROP TRIGGER IF EXISTS research_task_remediation_relationship_diagnostic_refresh ON research_task;
DROP FUNCTION IF EXISTS research_artifact_task_remediation_diagnostic_refresh_fn();
DROP FUNCTION IF EXISTS research_artifact_scan_research_task_migration_diagnostics(UUID,UUID,UUID);
DROP FUNCTION IF EXISTS research_artifact_diagnose_task_local_reference(UUID,UUID,UUID,INTEGER,INTEGER,TEXT,TEXT,TEXT);
DROP FUNCTION IF EXISTS research_artifact_diagnose_task_scoped_uuid_reference(UUID,UUID,UUID,TEXT,TEXT,TEXT);

DELETE FROM research_artifact_migration_diagnostic WHERE owner_kind='task';
