...
func (q *Queries) GetFleetDeliveryStats(ctx context.Context, arg GetFleetDeliveryStatsParams) ([]GetFleetDeliveryStatsRow, error) {
	...
	defer rows.Close()
	items := []GetFleetDeliveryStatsRow{}
	for rows.Next() {
...
type GetFleetEfficiencyStatsParams struct {
	WorkspaceID pgtype.UUID `json:"workspace_id"`
	WindowDays  int32       `json:"window_days"`
}
...
func (q *Queries) GetFleetEfficiencyStats(ctx context.Context, arg GetFleetEfficiencyStatsParams) ([]GetFleetEfficiencyStatsRow, error) {
	rows, err := q.db.Query(ctx, getFleetEfficiencyStats, arg.WorkspaceID, arg.WindowDays)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
	items := []GetFleetEfficiencyStatsRow{}
	for rows.Next() {
...
type GetFleetEvolutionFeedbackStatsParams struct {
	WorkspaceID pgtype.UUID `json:"workspace_id"`
	WindowDays  int32       `json:"window_days"`
}
...
func (q *Queries) GetFleetEvolutionFeedbackStats(ctx context.Context, arg GetFleetEvolutionFeedbackStatsParams) ([]GetFleetEvolutionFeedbackStatsRow, error) {
	rows, err := q.db.Query(ctx, getFleetEvolutionFeedbackStats, arg.WorkspaceID, arg.WindowDays)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
	items := []GetFleetEvolutionFeedbackStatsRow{}
	for rows.Next() {
...
type GetFleetEvolutionPromotionStatsParams struct {
	WorkspaceID pgtype.UUID `json:"workspace_id"`
	WindowDays  int32       `json:"window_days"`
}
...
func (q *Queries) GetFleetEvolutionPromotionStats(ctx context.Context, arg GetFleetEvolutionPromotionStatsParams) ([]GetFleetEvolutionPromotionStatsRow, error) {
	rows, err := q.db.Query(ctx, getFleetEvolutionPromotionStats, arg.WorkspaceID, arg.WindowDays)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
	items := []GetFleetEvolutionPromotionStatsRow{}
	for rows.Next() {
...
SELECT
    amwe.agent_id,
    COUNT(*) FILTER (WHERE amwe.created_at > now() - make_interval(days => $1::int))::bigint AS writes_30d,
...
type GetFleetGrowthStatsParams struct {
	WindowDays  int32       `json:"window_days"`
	WorkspaceID pgtype.UUID `json:"workspace_id"`
}
...
func (q *Queries) GetFleetGrowthStats(ctx context.Context, arg GetFleetGrowthStatsParams) ([]GetFleetGrowthStatsRow, error) {
	rows, err := q.db.Query(ctx, getFleetGrowthStats, arg.WindowDays, arg.WorkspaceID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
	items := []GetFleetGrowthStatsRow{}
	for rows.Next() {
...
RETURNING id, workspace_id, agent_id, fleet_score, class_id, fleet_rank, fleet_size, sample_tasks, pillar_delivery, pillar_evolution, pillar_growth, pillar_efficiency, trigger_reason, recorded_at
`
...
SELECT id, workspace_id, agent_id, fleet_score, class_id, fleet_rank, fleet_size, sample_tasks, pillar_delivery, pillar_evolution, pillar_growth, pillar_efficiency, trigger_reason, recorded_at FROM agent_fleet_history
WHERE workspace_id = $1 AND agent_id = $2
