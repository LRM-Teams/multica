...
const (
	...
	EventAgentDetached            = "agent:detached"
	EventAgentAttachmentReplayReq = "agent:attachment.replay_request"
	EventAgentAttachmentReplayEnd = "agent:attachment.replay_end"
